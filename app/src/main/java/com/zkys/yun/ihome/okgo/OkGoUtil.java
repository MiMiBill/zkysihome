package com.zkys.yun.ihome.okgo;
...
//        headers.put("TES", "2");
//        String PAD = ActiveUtils.getRequestHeader();
//        if (!TextUtils.isEmpty(PAD)) {
//            headers.put("PAD", PAD);
//        }
//        if (!TextUtils.isEmpty(ActiveUtils.getRequestHeader())) {
//            headers.put(Constant.AUTHORIZATION, "Bearer " + ActiveUtils.getRequestHeader());
//        }
        //headers.put("PAD", "2");
